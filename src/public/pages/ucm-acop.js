...
selectedComp = "";
const GetUCMACOPler = async () => {
  const {data} = await GetSertifikalar("ucm-acop");
...
export const UCMACOPInit = async (route) => {
  console.log("dsad");
  ...
  $("#save").on("click",async function (e) {
    ...
    if (!Object.values(formData).some((item) => item == "")) {
      ...
      await AddSertifika("ucm-acop", formData);
      GetUCMACOPler();
  ...
  $("#update").on("click",async function (e) {
    ...
    if (!Object.values(formData).some((item) => item == "")) {
      ...
      await UpdateSertifika("ucm-acop", {id:selectedComp.id,...formData});
      GetUCMACOPler();
      $(".spinner-area").addClass("!hidden");
    } else {
      $(".msg-area").html(
  ...
  $("#delete").on("click",async function (e) {
    await DeleteSertifika("ucm-acop", {
      id: selectedComp.id,
      filepath: selectedComp.cert_filepath,
    });
    GetUCMACOPler();
