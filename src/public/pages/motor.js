...
export const MotorInit = async (route) => {
  ...
  $("#save").on("click", async function (e) {
    ...
    if (!Object.values(formData).some((item) => item == "")) {
      ...
      await AddSertifika("motor", formData);
      GetMotorlar();
  ...
  $("#update").on("click", async function (e) {
    ...
    if (!Object.values(formData).some((item) => item == "")) {
      ...
      await UpdateSertifika("motor", { id: selectedComp.id, ...formData });
      GetMotorlar();
      $(".spinner-area").addClass("!hidden");
    } else {
      $(".msg-area").html(
