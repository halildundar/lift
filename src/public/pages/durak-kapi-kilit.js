...
selectedComp = "";
const GetDurakKapiKilitleri = async () => {
...
export const DurakKapiKilitInit = async (route) => {
  onayKurumlar = await GetListOnayKurumlar();
  GetDurakKapiKilitleri();
  onSelectDosya();
  $("#save").on("click",async function (e) {
    $(".msg-area").html("");
    let filename = "LANDING DOOR LOCKING";
    ...
    if (!Object.values(formData).some((item) => item == "")) {
      ...
      await AddSertifika("durak-kapi-kilit", formData);
      GetDurakKapiKilitleri();
  ...
  $("#update").on("click",async function (e) {
    ...
    if (!Object.values(formData).some((item) => item == "")) {
      ...
      await UpdateSertifika("durak-kapi-kilit", {id:selectedComp.id,...formData});
      GetDurakKapiKilitleri();
      $(".spinner-area").addClass("!hidden");
    } else {
      $(".msg-area").html(
  ...
  $("#delete").on("click",async function (e) {
    await DeleteSertifika("durak-kapi-kilit", {
      id: selectedComp.id,
      filepath: selectedComp.cert_filepath,
    });
    GetDurakKapiKilitleri();
