...
export const KontrolKartnInit = async (route) => {
  onayKurumlar = await GetListOnayKurumlar();
  GetKontrolKartlar();
  onSelectDosya();
  $("#save").on("click", async function (e) {
    $(".msg-area").html("");
    let filename = "Maiin Board";
    ...
    if (!Object.values(formData).some((item) => item == "")) {
      ...
      await AddSertifika("kontrol-kart", formData);
      GetKontrolKartlar();
  ...
  $("#update").on("click", async function (e) {
    ...
    if (!Object.values(formData).some((item) => item == "")) {
      ...
      await UpdateSertifika("kontrol-kart", {
        id: selectedComp.id,
        ...formData,
      });
      GetKontrolKartlar();
  ...
  $("#delete").on("click", async function (e) {
    await DeleteSertifika("kontrol-kart", {
      id: selectedComp.id,
      filepath: selectedComp.cert_filepath,
    });
    GetKontrolKartlar();
