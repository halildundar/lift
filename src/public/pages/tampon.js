import { Upload, FileValidation, TrToEnChar } from "../util/fncs.js";
import {
  GetListOnayKurumlar,
  AddSertifika,
  GetSertifikalar,
...
export const TamponInit = async (route) => {
  ...
  $("#save").on("click", async function (e) {
    ...
    if (!Object.values(formData).some((item) => item == "")) {
      ...
      await AddSertifika("tampon", formData);
      GetTamponlar();
  ...
  $("#update").on("click", async function (e) {
    ...
    if (!Object.values(formData).some((item) => item == "")) {
      ...
      await UpdateSertifika("tampon", { id: selectedComp.id, ...formData });
      GetTamponlar();
      $(".spinner-area").addClass("!hidden");
    } else {
      $(".msg-area").html(
